...
async function createPreference(req, res, next){
    try {
        ...
        let preferenceQuery = {
            ...
            binary_mode: true,
            back_urls: {
                success: "https://d9ec-181-10-200-196.ngrok-free.app/src/public/index-prueba-local/index.html",
                failure: "https://d9ec-181-10-200-196.ngrok-free.app/src/public/index-prueba-local/index.html",
            },
            ...
            notification_url: 'https://d9ec-181-10-200-196.ngrok-free.app/api/checkout/notify',
            statement_descriptor: 'Natural Icy Market',
            external_reference: random_code.toString()
        };

        if(phone){
            preferenceQuery.payer['phone'] = {
